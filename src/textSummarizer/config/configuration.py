from src.textSummarizer.constants import PARAMS_FILE_PATH,CONFIG_FILE_PATH
...
class ConfigurationManager:
    def __init__(self, params_filepath=PARAMS_FILE_PATH, config_filepath=CONFIG_FILE_PATH):
